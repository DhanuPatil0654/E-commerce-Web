...
import pantimg from '../../images/Pants/pant_formal1.png'
...
function Pants_mobileview() {
  ...
  const pants_data = [
    ...
    return (
        <>
            <Container fluid className='mt-5 pt-5 d-block d-md-none'>
                <Row>
                    {
                        pants_data.map((a) => {
                            return (
                                <>
                                    <Col xl={2} lg={2} md={4} sm={6} xs={6} className='mb-3'>
                                        <Card variant="outlined" className='customercard_mobileview'>
                                            <Box sx={{ p: 2 }}>
                                                <CardMedia
                                                    component="img"
                                                    alt="pant image"
...
export default Pants_mobileview
